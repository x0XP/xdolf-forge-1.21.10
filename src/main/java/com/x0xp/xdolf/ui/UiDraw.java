...
public final class UiDraw {
    ...
    public static void setGlobalAlpha(float alpha) { globalAlpha = clamp01(alpha); }
    public static float globalAlpha() { return globalAlpha; }

    public static void rect(GuiGraphics graphics, float x, float y, float right, float bottom, int color) {
    ...
    public static void outline(GuiGraphics graphics, float x, float y, float right, float bottom, int color) {
    ...
    public static void border(GuiGraphics graphics, float x, float y, float right, float bottom, int inside) {
    ...
    public static boolean hit(double mouseX, double mouseY, double x, double y, double width, double height) {
